...
bot.on('message', (message) => {
    if (message.author.equals(bot.user)) return;
        ...
        if(message.content.match (/Emanuel/i)){
        return
    }
        if(message.content.match (/Manu/i) && (message.content.match (/dab/i))) {
        return message.channel.sendMessage("Non non non, je suis pas ton copain, hein, non non non non. Mais je ne peux résister..."), message.channel.sendFile("./dab/macron turbo.png")
    }
        ...
        if(message.content.match (/Emanuel/i) && (message.content.match (/dab/i))) {
        return message.channel.sendFile("./dab/macron dab.png")
    }
